...
/*  Created On : 17-Oct-2016 11:53:07 PM 				*/
...
ALTER TABLE [movements] ADD CONSTRAINT [FK_movements_stock]
	FOREIGN KEY ([mov_id_stock_ingredient],[mov_id_warehouse]) REFERENCES [stock] ([sto_id_ing],[war_id]) ON DELETE No Action ON UPDATE No Action
GO
